...
public class DialogTips extends DialogBase {
     ...
     * @param title
     */
    public DialogTips(Context context,String title,String positive,String negitive){
         super(context);
         super.setHasBody(hasBody);
         super.setTitle(title);
         super.setNameNegativeButton(negitive);
         super.setNamePositiveButton(positive);
    }

    public DialogTips(Context context,String title,String positive,boolean hasBody,String negitive,boolean hasNegative){
        super(context);
        super.setHasBody(hasBody);
        this.hasNegative =hasNegative;
        super.setTitle(title);

        super.setMessage(negitive);
        super.setNamePositiveButton(positive);
    }

    public DialogTips(Context context, String message,String buttonText,String negetiveText,String title) {
        super(context);
        super.setMessage(message);
        super.setNamePositiveButton(buttonText);
        this.hasNegative=false;
